                ...
                <div className="w-full md:w-auto" ref={categoryFilterRef}>
                  <div className="relative">
                    ...
                    >
                      ...
                      <ChevronDown
                        className={`w-4 h-4 transition-transform duration-200 ${isCategoryFilterOpen ? 'transform rotate-180' : ''
                          }`}
                      />
                    </button>
                          ...
                          {parentCategories.map((parentCat) => (
                            <div key={parentCat.id} className="border-b border-gray-700 last:border-b-0 pb-2 last:pb-0">
                              ...
                              >
                                ...
                                <ChevronDown
                                  className={`w-4 h-4 transition-transform duration-200 ${openDropdowns[parentCat.id] ? 'transform rotate-180' : ''
                                    }`}
                                />
                              </button>
